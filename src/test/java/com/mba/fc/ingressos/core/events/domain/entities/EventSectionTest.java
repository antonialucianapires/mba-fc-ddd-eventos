...
class EventSectionTest {
    ...
    class FactoryMethod {
        ...
        void shouldGenerateDistinctIds() {
            EventSection a = EventSection.create(VALID_NAME, VALID_DESCRIPTION, VALID_TOTAL_SPOTS, VALID_PRICE);
            EventSection b = EventSection.create(VALID_NAME, VALID_DESCRIPTION, VALID_TOTAL_SPOTS, VALID_PRICE);
    ...
    class Equality {
        ...
        void shouldBeEqualToItself() {
            EventSection section = EventSection.create(VALID_NAME, VALID_DESCRIPTION, VALID_TOTAL_SPOTS, VALID_PRICE);
